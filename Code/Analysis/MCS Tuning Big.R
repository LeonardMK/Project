...
save(mcs_sparse_not, file = paste0(str_path, "/mcs_sparse_not_big.RData"))
rm(mcs_sparse_not)
...
save(mcs_sparse_rcv, file = paste0(str_path, "/mcs_sparse_rcv_big.RData"))
rm(mcs_sparse_rcv)
...
save(mcs_sine_not, file = paste0(str_path, "/mcs_sine_not_big.RData"))
rm(mcs_sine_not)
...
save(mcs_sine_rcv, file = paste0(str_path, "/mcs_sine_rcv_big.RData"))
rm(mcs_sine_rcv)
...
save(mcs_inter_not, file = paste0(str_path, "/mcs_inter_not_big.RData"))
rm(mcs_inter_not)
...
save(mcs_inter_rcv, file = paste0(str_path, "/mcs_inter_rcv_big.RData"))
rm(mcs_inter_rcv)
...
neural <- neural %>% samples(N = c(1600), Samples = 1:200)
...
save(mcs_neural_not, file = paste0(str_path, "/mcs_neural_not_big.RData"))
rm(mcs_neural_not)
...
save(mcs_neural_rcv, file = paste0(str_path, "/mcs_neural_rcv_big.RData"))
rm(mcs_neural_rcv)
